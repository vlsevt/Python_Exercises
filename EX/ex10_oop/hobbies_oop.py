...
def filter_by_hobby(people_list: list[Person], hobby: str) -> list:
    """
...
def sort_by_most_hobbies(people_list: list[Person]) -> list:
    """
    ...
    """
    return sorted(people_list, key=lambda hobby: (-len(hobby.hobbies), hobby.full_name))


def sort_by_least_hobbies(people_list: list[Person]) -> list:
    """
...
def sort_people_and_hobbies(people_list: list[Person]) -> list:
    """
    ...
    for person in people_list:
        person.hobbies.sort()
    return sorted(people_list, key=lambda hobby: hobby.full_name)
